...
REAL(KIND=JPRB)   ,INTENT(OUT), CONTIGUOUS  :: PIA(:,:)
!INTEGER(KIND=JPIM),INTENT(IN),OPTIONAL, CONTIGUOUS :: KFLDPTR(:)
INTEGER(KIND=JPIM),INTENT(IN),OPTIONAL :: KFLDPTR(:) ! KISS w.a. OPTIONAL, CONTIGUOUS issue with ifort 2021.4.0
