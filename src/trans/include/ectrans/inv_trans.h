...
REAL(KIND=JPRB)    ,OPTIONAL, INTENT(IN), CONTIGUOUS :: PSPVOR(:,:)
REAL(KIND=JPRB)    ,OPTIONAL, INTENT(IN), CONTIGUOUS :: PSPDIV(:,:)
REAL(KIND=JPRB)    ,OPTIONAL, INTENT(IN), CONTIGUOUS :: PSPSCALAR(:,:)
REAL(KIND=JPRB)    ,OPTIONAL, INTENT(IN), CONTIGUOUS :: PSPSC3A(:,:,:)
REAL(KIND=JPRB)    ,OPTIONAL, INTENT(IN), CONTIGUOUS :: PSPSC3B(:,:,:)
REAL(KIND=JPRB)    ,OPTIONAL, INTENT(IN), CONTIGUOUS :: PSPSC2(:,:)
